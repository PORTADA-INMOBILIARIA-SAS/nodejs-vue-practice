<template>
  <a :href="`/inmueble/${inmueble.Codigo_Inmueble}`">
    <div
      class="h-[450px] w-full rounded-md overflow-hidden shadow-custom bg-white apt-card cursor-pointer"
    >
      <div class="h-full w-full relative overflow-hidden">
        ...
        >
          <svg
            ...
            class="icon icon-tabler icon-tabler-heart heart"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            stroke-width="2"
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="hidden icon icon-tabler icon-tabler-heart-filled heart-filled"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            stroke-width="2"
        ...
        >
          <div class="absolute bottom-4 px-4 w-full">
            <div
              class="md:text-xl w-full absolute bottom-12 text-inmueble px-4 left-0 text-center text-balance"
            >
              <span>{{
            ...
            <div
              class="text-base font-light h-20 w-full justify-center items-center text-center gap-4 pb-3 info-inmueble"
            >
              <div class="flex flex-col">
                ...
                <span>{{ inmueble.AreaLote }} m²</span>
              </div>

              <div class="flex flex-col h-full w-[2px] bg-gray-200"></div>
              ...
              <div class="flex flex-col">
                ...
                <span>{{ inmueble.garaje }}</span>
              </div>
            </div>
            <div class="h-[1px] w-full bg-white my-2"></div>
            <div class="flex justify-between font-bold md:text-xl uppercase">
              <span>{{ inmueble.Gestion }}</span>
...
.apt-card .text-inmueble {
  transition: bottom 0.8s ease; /* Agregando transición a la propiedad bottom */
}

.apt-card:hover .text-inmueble {
  bottom: 8rem;
}
...
.apt-card .bottom-info {
  overflow: hidden;
  transition: height 0.8s ease; /* Agrega una transición a la altura */
}

.apt-card:hover .bottom-info {
  height: 60%;
}
