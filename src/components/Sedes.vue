<template>
  <div class="grid grid-cols-2 mx-4 text-sm md:text-lg">
    <div class="col-start-1 col-end-2">
      ...
      <div
        class="min-w-fit w-[55%] bg-gray-900 text-white uppercase px-2 py-1 mt-1"
      >
    ...
    <div class="col-start-2 col-end-3 text-right">
      <transition name="fade" mode="out-in">
        <div
          class="flex flex-col h-[100%] justify-center items-end"
        ...
        >
          ...
          <div class="mt-2">
            <span class="text-4xl md:text-7xl font-bold uppercase">{{
              infoSedes[sedeSeleccionada].nombre
            }}</span>
          </div>
